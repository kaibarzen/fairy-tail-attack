...
const devDeck: Deck = {
	...
	cards: [
		...
		},
		{
			...
			text: <div>OH FUCK HES COMING LAD <Damage> 6 </Damage> <Shield> 5 </Shield> <Hp> 5 </Hp> <MaxHp> 6 </MaxHp>
				<Card> 5 </Card> dasd <HandCard> 4 </HandCard> <EquipedCard> 5 </EquipedCard> <Expose> 1 </Expose>
				<Player> ALL </Player></div>,
